...
**Цель:** рейтинг прогресса пациентов с диабетом по выбранной метрике и периоду; в таблице — потреблённые продукты с ХЕ и медалями топ-5 по БЖЕ.

### Стиль (обязательно)

- Tabs Table/Scatter: `--muted` inactive, `--primary` active indicator
- Медали топ-5 БЖЕ на продукты: gold `#FFD700`, silver `#C0C0C0`, bronze `#CD7F32`, 4th `#9CA3AF`, 5th `#78716F` (badge на иконке продукта)
- Иконки продуктов + подпись ХЕ: monospace для числа, tooltip с полным названием и БЖЕ
...
├─────────────────────────────────────────────────────────────────┤
│ TABLE MODE:                                                     │
│ # │ Patient      │ ████████░░ 72% │ 🍞 12 ХЕ 🥇  🥛 8 ХЕ  …     │
│ 1 │ Мария С.     │ ...            │ продукты + ХЕ + медали БЖЕ  │
├─────────────────────────────────────────────────────────────────┤
│ SCATTER MODE:                                                   │
│     Y (metric_y)                                                │
│        ·  ·                                                     │
