...
**Текущее состояние:** spec UI ✅ (iter 0) · backend web API ✅ (iter 1) · web scaffold ✅ (iter 2) · patient dashboard ✅ (iter 3).

**Прогресс:** **4 / 10** итераций ✅ · **4 / 10** задач ✅ · **следующая:** iter 4 — [лидерборд](impl/frontend/iteration-4-leaderboard/plan.md) · [plan области](impl/frontend/plan.md)
...
| 4 | Лидерборд | 04 | 📋 Next | [plan](impl/frontend/iteration-4-leaderboard/plan.md) |
...
| 04 | Лидерборд | 📋 Next | [план](impl/frontend/iteration-4-leaderboard/tasks/task-04-leaderboard/plan.md) |
...
| 4 | Leaderboard | table/scatter, продукты+ХЕ, топ-5 БЖЕ медалями | 📋 Next |
