...
**User-check (пользователь):** login пациента из seed → `/dashboard`; `akozhin` → `/leaderboard`; навигация, FAB, logout.
...
| 2 | Next.js scaffold | 🚧 partial — init ✅; auth/shell/FAB pending |
| 3 | Панель пациента с диабетом | live API, личные KPI + matrix |
