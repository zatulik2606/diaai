...
**Прогресс:** **2 / 5** итераций · **2 / 5** задач (01–02 ✅) · **следующая:** итерация 3 · [`docs/spec/`](../../spec/) · [impl/database/summary.md](impl/database/summary.md)
...
| 3 | ADR и практика доступа к БД | 03 | 📋 Next | [plan](impl/database/iteration-3-data-access-adr/plan.md) · [summary](impl/database/iteration-3-data-access-adr/summary.md) |
...
| 03 | ADR и практика: миграции и доступ к БД | 📋 Next | [план](impl/database/iteration-3-data-access-adr/tasks/task-03-data-access-adr/plan.md) · [summary](impl/database/iteration-3-data-access-adr/tasks/task-03-data-access-adr/summary.md) |
...
Итерации выполняются **последовательно** (1 → 5). Итерации **1–2** закрыты ✅; **3** — следующая.
...
## Итерация 3: ADR и практика доступа к БД 📋 *(Next)*
