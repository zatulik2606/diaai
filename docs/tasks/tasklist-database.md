...
**Прогресс:** **4 / 5** итераций · **4 / 5** задач (01–04 ✅) · **следующая:** итерация 5 · [`data/progress-import.v1.json`](../../data/progress-import.v1.json) · [impl/database/summary.md](impl/database/summary.md)
...
| `scripts/db/seed_from_progress.py`, `db_inspect.py` | **создать** |
| `Makefile` | цели `db-*` |
...
| [database-access.md](../tech/database-access.md) | практический guide (миграции, 5 шагов) |
